...
#    print(distance2)
  ...
  write.table(data.frame(annotation_table[line,], 
    ...
    end_new_coor_chr[line], end_new_coor[line], distance_end[line]), paste0("parallel_temp_final_",sample,"_S_",scalfold, "_refCoor.txt"), 
...
annotation_table %>% 
  ...
  write.table(paste0("parallel_final_",sample,"_S_",scalfold, "_refCoor.txt"), quote = FALSE, row.names = FALSE, col.names = FALSE, sep="\t")
