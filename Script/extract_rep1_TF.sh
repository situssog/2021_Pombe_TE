...
cp /proj/uppstore2017159/b2014286_nobackup/private/pac_bio/02_TE/all21_samples/CARP_TF/fungi.fa /proj/uppstore2017159/b2014286_nobackup/private/pac_bio/02_TE/all21_samples/CARP_TF/$ref_seq.fa ./

censor.ncbi -debug -lib ./fungi.fa -lib ./$ref_seq.fa ConsensusSequences.fa
...
sed -i 's/annotationfiles\/our_known_reps_20130520.fasta/'$ref_seq'.fa/g' ClassifyConsensusSequences.java
